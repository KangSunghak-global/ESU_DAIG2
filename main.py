...
class MyWindow(QMainWindow, form_class):
    def __init__(self):
        ...
        self.setupUi(self)
        self.pushButton.clicked.connect(self.VersionRead_click)  # button instance connect with event function
        ...
        self.timer = QTimer()  # Timer instance
    ...
    def timerEvent(self):
        if self.count >= 60:
            self.timer.stop()
            self.textEdit_2.setText("Count End")
            self.count = 0
        else:
            self.count += 1
